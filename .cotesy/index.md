...
| Topic | File | Summary |
|---|---|---|
| Architecture (index) | docs/ARCHITECTURE.md | Components (one-liners), data flow, cross-topic decisions, and dependencies. |
| Plugin structure | docs/plugin-structure.md | Repo layout conventions and skill/agent discovery, plus a marketplace-registration gotcha. |
| Scopes | docs/scopes.md | Nested `.cotesy/` scope creation and `--to <ancestor>` promotion gotcha. |
